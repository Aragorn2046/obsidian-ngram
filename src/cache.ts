...
import type { BlueprintData, CachedData, NgramSettings } from "./types";
...
export class BlueprintCache {
  ...
  async save(data: BlueprintData, settings: NgramSettings): Promise<void> {
  ...
  isFresh(cached: CachedData, currentSettings: NgramSettings): boolean {
  ...
  private hashSettings(settings: NgramSettings): string {
